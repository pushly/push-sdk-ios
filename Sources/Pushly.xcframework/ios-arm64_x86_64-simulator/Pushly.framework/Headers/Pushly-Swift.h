...
+ (void)clearCart;
+ (void)trackPurchase;
+ (void)trackPurchaseOf:(NSArray<PNECommItem *> * _Nullable)items withPurchaseId:(NSString * _Nullable)purchaseId withPriceValue:(NSString * _Nullable)priceValue;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nullable deviceToken;)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) enum PNSubscriberStatus subcriberStatus;)
+ (enum PNSubscriberStatus)subcriberStatus SWIFT_WARN_UNUSED_RESULT;
