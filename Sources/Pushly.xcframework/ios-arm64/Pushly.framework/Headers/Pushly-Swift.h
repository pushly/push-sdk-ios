...
@class NSNumber;
SWIFT_CLASS("_TtC6Pushly11CatalogItem")
...
- (nonnull instancetype)initWithId:(NSString * _Nonnull)id quantity:(NSNumber * _Nullable)quantity rating:(NSNumber * _Nullable)rating OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_ENUM_FWD_DECL(NSInteger, PNAppMessageStyle)
@class PNSchedule;
...
/// Human-readable breakdown of the eligibility sub-checks. Diagnostics only —
/// logged (at verbose) to explain why a message is or isn’t shown.
- (NSString * _Nonnull)eligibilityDescription SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_ENUM_FWD_DECL(NSInteger, PNECommItemType)
...
typedef SWIFT_ENUM(NSInteger, PNECommItemType, open) {
  ...
  PNECommItemTypeRecipe = 2,
  PNECommItemTypeUnknown = 3,
};
...
typedef SWIFT_ENUM(NSInteger, PNLogPrivacy, open) {
  PNLogPrivacyPublic = 0,
  PNLogPrivacyPrivate = 1,
};

SWIFT_CLASS("_TtC6Pushly8PNLogger")
@interface PNLogger : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
/// The minimum log level required for messages to be emitted.
...
- (void)verbose:(NSString * _Nonnull)message privacy:(enum PNLogPrivacy)privacy;
- (void)debug:(NSString * _Nonnull)message privacy:(enum PNLogPrivacy)privacy;
- (void)info:(NSString * _Nonnull)message privacy:(enum PNLogPrivacy)privacy;
- (void)warn:(NSString * _Nonnull)message privacy:(enum PNLogPrivacy)privacy;
- (void)error:(NSString * _Nonnull)message privacy:(enum PNLogPrivacy)privacy;
- (void)critical:(NSString * _Nonnull)message privacy:(enum PNLogPrivacy)privacy;
/// Returns whether a given log level would produce output given the current <code>logLevel</code> setting.
...
SWIFT_ENUM_FWD_DECL(NSInteger, PNNotificationActionType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, PNNotificationInteractionType)
...
- (nonnull instancetype)initWithDefaultOpenWith:(PNNotification * _Nonnull)notification OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_ENUM_FWD_DECL(NSInteger, PNPromptType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, PNSubscriberStatus)
...
+ (void)saveItemWithItem:(CatalogItem * _Nonnull)item;
+ (void)unsaveItemWithItem:(CatalogItem * _Nonnull)item;
+ (void)completeItemWithItem:(CatalogItem * _Nonnull)item;
+ (void)uncompleteItemWithItem:(CatalogItem * _Nonnull)item;
+ (void)rateItemWithItem:(CatalogItem * _Nonnull)item;
+ (void)unrateItemWithItem:(CatalogItem * _Nonnull)item;
+ (void)viewItemWithItem:(CatalogItem * _Nonnull)item;
+ (void)addToCartWithItems:(NSArray<CatalogItem *> * _Nonnull)items;
+ (void)updateCartWithItems:(NSArray<CatalogItem *> * _Nonnull)items;
+ (void)clearCart;
+ (void)trackPurchase;
+ (void)trackPurchaseOf:(NSArray<CatalogItem *> * _Nonnull)items withPurchaseId:(NSString * _Nullable)purchaseId withPriceValue:(NSString * _Nullable)priceValue;
+ (void)withECommConfig:(void (^ _Nonnull)(PNECommConfig * _Nonnull))block caller:(NSString * _Nonnull)caller;
+ (BOOL)isValidRating:(NSNumber * _Nonnull)rating SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
